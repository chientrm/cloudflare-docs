...
- Some arrays contain scalar types (e.g. `[String]`) and function like ordinary fields that [can be filtered](/analytics/graphql-api/features/filtering/)
- Some arrays contain more complex types (e.g. `[Subrequest]`.) The following section describes their behaviour.
